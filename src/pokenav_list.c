...
static u32 LoopedTask_PrintListItems(s32 state)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(
            listSub->listWindow.windowId,
            listSub->listWindow.fontId,
            listSub->itemTextBuffer,
#if ENGLISH
            8,
#elif GERMAN
            10,
...
static void CreateListArrowSprites(struct PokenavListWindowState *windowState, struct PokenavListSub *list)
{
    ...
    spriteId = CreateSprite(
        &sSpriteTemplate_RightArrow,
#if ENGLISH
        list->listWindow.x * 8 + 3,
#elif GERMAN
        list->listWindow.x * 8 + 5,
#endif
        (list->listWindow.y + 1) * 8,
        7
    );
