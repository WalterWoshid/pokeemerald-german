...
#elif GERMAN
    {EC_WORD_I_AM, EC_WORD_LOST, EC_WORD_I, EC_WORD_NEED, EC_WORD_AN, EC_MOVE2(HELPING_HAND)},
    {EC_WORD_I, EC_WORD_KNOWS, EC_WORD_DON_T, EC_WORD_WHERE, EC_WORD_I_AM, EC_WORD_EXCL},
    {EC_WORD_WHAT, EC_WORD_MUST_BE, EC_WORD_I, EC_WORD_NOW, EC_WORD_MAKE, EC_WORD_QUES},
    {EC_WORD_IT_S, EC_WORD_MYSELF, EC_WORD_TO, EC_WORD_EXCITING, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_WAS, EC_WORD_THAT, EC_WORD_AROUND, EC_WORD_A, EC_WORD_MISTAKE, EC_WORD_QUES},
    {EC_WORD_IS_IT_QUES, EC_WORD_MEAN, EC_WORD_AND, EC_WORD_TERRIBLE, EC_WORD_HERE, EC_WORD_ELLIPSIS},
    {EC_WORD_THE, EC_WORD_PLACE, EC_WORD_DOESN_T, EC_WORD_ME, EC_WORD_TIRED, EC_WORD_ELLIPSIS},
    {EC_WORD_AN, EC_WORD_CHALLENGE, EC_WORD_IS, EC_WORD_TO, EC_WORD_ENJOY, EC_WORD_EXCL},
    {EC_WORD_LOOKS, EC_WORD_HOW_DO, EC_WORD_I, EC_WORD_THAT, EC_WORD_DO, EC_WORD_EXCL},
    {EC_WORD_READY, EC_WORD_THOSE_ARE, EC_WORD_OUT, EC_WORD_TO, EC_WORD_GIVE, EC_WORD_QUES},
    {EC_WORD_OH, EC_WORD_NO, EC_WORD_WHO, EC_WORD_ARE, EC_WORD_YOU, EC_WORD_QUES},
    {EC_WORD_I_AM, EC_WORD_THOSE_ARE, EC_WORD_FOREVER, EC_WORD_WALKING, EC_WORD_ELLIPSIS, EC_EMPTY_WORD},
    {EC_WORD_I, EC_WORD_WANTS, EC_WORD_NOW, EC_WORD_GIVE_UP, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_WHAT, EC_WORD_DO, EC_WORD_I, EC_WORD_THAN, EC_WORD_NEXT, EC_WORD_QUES},
    {EC_WORD_WHEN_I_WIN, EC_WORD_WITH, EC_MOVE(SHEER_COLD), EC_WORD_I, EC_WORD_GENIUS, EC_WORD_QUES},
    {EC_WORD_IS, EC_WORD_HERE, EC_WORD_SOMEONE, EC_WORD_FULL, EC_WORD_COOLNESS, EC_WORD_QUES},
    {EC_WORD_FIGHTING, EC_WORD_GAME, EC_WORD_IS, EC_WORD_AWESOME, EC_WORD_AND, EC_WORD_EXCITING},
    {EC_WORD_THAT, EC_WORD_IS, EC_WORD_DON_T, EC_WORD_TO, EC_WORD_TAKE, EC_WORD_EXCL},
    {EC_WORD_I, EC_WORD_KNOWS, EC_WORD_DON_T, EC_WORD_IS, EC_WORD_THAT, EC_WORD_OK_QUES},
    {EC_WORD_OH, EC_WORD_NO, EC_WORD_NONE, EC_WORD_KINDERGARTEN, EC_WORD_TRAINER, EC_WORD_EXCL},
    {EC_WORD_IT, EC_WORD_MUST_BE, EC_WORD_NOW, EC_WORD_AFTER, EC_WORD_LEFT, EC_WORD_GOING},
    {EC_WORD_IT, EC_WORD_MUST_BE, EC_WORD_SOON, EC_WORD_DONE, EC_WORD_HIS, EC_WORD_ISN_T_IT_QUES},
    {EC_WORD_THAT, EC_WORD_IS, EC_WORD_FULL, EC_WORD_SIMPLE, EC_WORD_OR, EC_WORD_QUES},
    {EC_WORD_I, EC_WORD_WANTS, EC_WORD_GO_AHEAD, EC_WORD_MAKE, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_I, EC_WORD_WON_T, EC_WORD_GIVE_UP, EC_WORD_EXCL, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_I, EC_WORD_WON_T, EC_WORD_WINS, EC_WORD_CAN, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_ONLY, EC_WORD_GO_AHEAD, EC_WORD_ELLIPSIS, EC_WORD_I_AM, EC_WORD_WEAKENED, EC_EMPTY_WORD},
    {EC_WORD_ALWAYS, EC_WORD_TRAINER, EC_WORD_AFTER, EC_WORD_TRAINER, EC_WORD_ELLIPSIS, EC_EMPTY_WORD},
    {EC_WORD_I_VE, EC_WORD_LIKES, EC_WORD_FOR, EC_WORD_STEEL, EC_WORD_POKEMON, EC_WORD_QUES},
    {EC_WORD_ALL, EC_WORD_TRAINER, EC_WORD_HERE, EC_WORD_THOSE, EC_WORD_TO, EC_WORD_WEAK},
    {EC_WORD_MAN, EC_WORD_THINKS, EC_WORD_THAT, EC_WORD_BE, EC_WORD_EASY, EC_WORD_QUES},
    {EC_WORD_WHAT, EC_WORD_BECOMES, EC_WORD_THAN, EC_WORD_NEXT, EC_WORD_COME, EC_WORD_QUES},
    {EC_WORD_I_AM, EC_WORD_SO, EC_WORD_CONFUSED, EC_WORD_EXCL, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_I, EC_WORD_WANTS, EC_WORD_ONLY, EC_WORD_GO_HOME, EC_WORD_ELLIPSIS, EC_EMPTY_WORD},
    {EC_WORD_YEEHAW_EXCL, EC_WORD_THE, EC_WORD_PLACE, EC_WORD_IS, EC_WORD_AN, EC_WORD_PUSHOVER},
    {EC_WORD_I_WAS, EC_WORD_DON_T, EC_WORD_IN, EC_WORD_FIGHT, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_MAYBE, EC_WORD_IS, EC_WORD_IT, EC_WORD_LATER, EC_WORD_CORRECT, EC_WORD_QUES},
    {EC_WORD_WAAAH, EC_WORD_EXCL, EC_WORD_SO, EC_WORD_WAS, EC_WORD_IT, EC_WORD_DON_T},
    {EC_WORD_WHO_WAS, EC_WORD_POKEMON, EC_WORD_THOSE, EC_WORD_TO, EC_WORD_TIRED, EC_WORD_ELLIPSIS},
    {EC_WORD_WHO_WAS, EC_WORD_POKEMON, EC_WORD_THOSE, EC_WORD_TOUGH, EC_WORD_VERSUS, EC_WORD_POISON},
    {EC_WORD_LALALA, EC_WORD_LALALA, EC_WORD_I_AM, EC_WORD_AWESOME, EC_WORD_LALALA, EC_EMPTY_WORD},
    {EC_MOVE2(TOXIC), EC_WORD_IS, EC_WORD_AWFUL, EC_WORD_ISN_T_IT_QUES, EC_EMPTY_WORD, EC_EMPTY_WORD},
#endif
};
